...
from slither_core.core.declarations import SolidityFunction, EnumContract, StructureContract
...
from slither_core.tools.flattening.export.export import (
    Export,
    export_as_json,
    save_to_zip,
    save_to_disk,
...
DEFAULT_EXPORT_PATH = Path("flattening")
...
class Flattening:
    ...
    def _check_abi_encoder_v2(self):
        ...
        for p in self._compilation_unit.pragma_directives:
            if "ABIEncoderV2" or "pragma abicoder v2" in str(p.directive):
    ...
    def _export_all(self) -> List[Export]:
        ...
        # Path(self._export_path, "export.sol")
        path = current_directory / "slither_flat.sol"
