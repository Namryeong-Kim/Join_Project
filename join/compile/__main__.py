...
def main() -> None:
    ...
    if args.filename.endswith('.zip'):
        ...
        clearinghouse_sol_files = find_clearinghouse_sol(extracted_files,filename)

        folder_name = filename.split(".")[0]
        print("folderName : ",folder_name)
        clearinghouse_folder_path = find_clearinghouse_folder(extracted_files,folder_name)
        ...
        relative_path = args.filename.split(target_directory)[0] + target_directory
